        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-300 mb-8 leading-relaxed">
              Our intelligent filtering system helps you narrow down choices based on 
              what matters most. Compare specifications, read reviews, and find the 
              perfect match for your playing style.
            </p>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative bg-slate-800/50 rounded-2xl border border-slate-700/50 p-6 backdrop-blur-sm">
              {/* Preview Header */}
                      ...
                      {metric.values.map((value, i) => (
                        <div key={i} className="flex-1 h-2 bg-slate-700 rounded-full overflow-hidden">
                          <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 0.8, delay: idx * 0.15 + i * 0.1 }}
