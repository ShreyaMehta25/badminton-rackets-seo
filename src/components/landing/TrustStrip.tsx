...
const trustItems = [
  {
    ...
    title: "Trusted by Competitive Players",
    description: "Used by coaches and tournament players",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: "Expert-Reviewed Specs",
    description: "Every specification verified by professionals",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: "Latest 2026 models and releases",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: "Data-driven recommendations only",
  },
];
