...
//         <button
//           onClick={() => router.back()}
//           className="inline-flex items-center gap-2 text-slate-800 hover:text-emerald-400 transition-colors group"
//         >
//           <svg
...
//               {/* Image container */}
//               <div className="relative bg-white backdrop-blur-md rounded-xl p-4 border border-slate-800/50 shadow-lg aspect-square flex items-center justify-center">
//                 <motion.img
//                   src={racket.imageUrl}
//                   alt={racket.name}
...
//               animate={{ opacity: 1 }}
//               transition={{ delay: 0.3 }}
//               className="text-slate-800 font-bold text-xs uppercase tracking-[0.15em]"
//             >
//               {racket.brand.toUpperCase()}
//             </motion.p>
...
//                 <span className="text-slate-800">{racket.weight}</span>
//               </span>
//               <span className="px-3 py-2 rounded-lg bg-slate-900/50 border border-slate-800 text-xs font-semibold uppercase tracking-wide backdrop-blur-sm">
...
//               className="space-y-1"
//             >
//               <p className="text-slate-800 text-xs uppercase tracking-wide">
//                 PRICE
//               </p>
