...
//   const allShoes = addIdsToProducts(shoes as Array<{
//     name: string;
//     brand: string;
//     price: number;
//     imageurl: string;
...
//     "@type": "CollectionPage",
//     name: "Badminton Shoes Directory",
//     description: "Complete collection of badminton shoes",
//     mainEntity: {
//       "@type": "ItemList",
//       numberOfItems: allShoes.length,
//       itemListElement: allShoes.slice(0, 10).map((shoe, index) => ({
//         "@type": "ListItem",
//         position: index + 1,
//         item: {
//           "@type": "Product",
...
//               <CategoryFilterSidebar products={allShoes} category="shoes" />
//             </aside>
...
export default function ShoesPage() {
  ...
  const allShoes = getUniqueProducts(
    addIdsToProducts(
      shoes as Array<{
        name: string;
        brand: string;
